...
#define dx12_assert(cond, fname) { wilog_assert(cond, "DX12 error: %s failed with %s (line %d)", fname, wi::helper::GetPlatformErrorString(hr).c_str(), __LINE__); }
...
namespace wi::graphics
{
	...
	public:
		...
		MemoryUsage GetMemoryUsage() const override
		{
			...
			retval.usage = budget.Stats.BlockBytes;
			return retval;
		}
